...
// XXX This one does use Optimize. Why is that?
...
// These are unique to this file (commented out in the other one)
...
// No BICing is done in the other file
...
// This is labeled slightly differently
...
// This for loop is muuuuch larger in the other file
...
// This optimization is done in the above for loop in the other file.
Optimize					  (res_three_LF_global,three_LFG);
writeTheLF (".relglobal.fit", "three_LFG");


// I think this is 4 in the other file?
// Everything after here is pretty dang different
OPTIMIZATION_METHOD         = 0;

fprintf (stdout, "Global model fit:");

// No BIC score in the other method
